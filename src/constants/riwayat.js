...
export const RIWAYAT_LIST = [
  ...
  // 8. أبو جعفر المدني
  { id: 'isa_an_abu_jafar', nameAr: 'إبن وردان عن أبي جعفر', category: 'ten_reads' },
  { id: 'sulayman_an_abu_jafar', nameAr: 'إبن جماز عن أبي جعفر', category: 'ten_reads' },
...
// تصدير كائن للتصفح السريع برمز الرواية
