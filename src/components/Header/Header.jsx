    ...
    >
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        <div className="relative" ref={notifRef}>
          ...
          {showNotifMenu && (
            <div className={`absolute top-full mt-2 w-72 sm:w-80 bg-slate-950 border border-slate-700/80 rounded-2xl shadow-2xl z-50 p-3.5 text-xs text-slate-300 ${activeRtl ? 'left-0' : 'right-0'}`}>
              <div className="flex justify-between items-center mb-2 pb-2 border-b border-white/10">
                <div className="flex items-center gap-2">
                  ...
                  {unreadCount > 0 && (
                    <span className="bg-amber-500/10 text-amber-400 border border-amber-500/20 text-[10px] px-1.5 py-0.5 rounded-full font-bold">
        ...
        <div className="relative" ref={profileRef}>
          ...
          {showProfileMenu && (
            <div className={`absolute top-full mt-2 w-48 bg-slate-950 border border-slate-700/80 rounded-2xl shadow-2xl z-50 p-3 text-xs text-slate-300 ${activeRtl ? 'left-0' : 'right-0'}`}>
