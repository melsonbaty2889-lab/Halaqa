  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="flex flex-col">
        {/* منطقة الحقول القابلة للتمرير بشكل كامل ومستقل */}
        <div className="flex-1 overflow-y-auto max-h-[58vh] sm:max-h-[62vh] space-y-4 px-1 pb-4">
          {submitError && (
        ...
        {/* أزرار الإجراءات المفصولة والمنفصلة تماماً في الأسفل */}
