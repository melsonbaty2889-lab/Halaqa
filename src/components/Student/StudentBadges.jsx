...
import GamificationStreaks from './GamificationStreaks';

export default function StudentBadges({ academyId, student = {}, weeklyData = [], isRtl = true }) {
  const targetAcademyId = academyId || student?.academy_id;

  // حساب الأوسمة الفردية للطالب
  ...
  return (
    <div dir={isRtl ? 'rtl' : 'ltr'} className="space-y-6">
      ...
      {/* استدعاء واجهة GamificationStreaks الإضافية */}
      <GamificationStreaks academyId={targetAcademyId} isRtl={isRtl} />
    </div>
  );
}
