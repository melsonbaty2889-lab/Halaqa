    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-full bg-slate-700/80 border border-slate-600/80 flex items-center justify-center text-slate-300 font-semibold group-hover:border-primary-500/50 group-hover:text-primary-400 transition-colors">
            {student.avatar_url ? (
        ...
        <div className="flex items-center gap-3">
          ...
          <ChevronLeft className="w-5 h-5 text-slate-500 group-hover:text-slate-300 group-hover:-translate-x-1 transition-all" />
        </div>
      </div>
    </div>
  );
