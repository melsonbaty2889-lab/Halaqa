      ...
      <form onSubmit={handleSignUp} className="flex flex-col gap-3">
        ...
        <div className="relative flex items-center">
          ...
          <input 
            ...
            required
            className={`w-full py-2.5 ${isRtl ? 'pr-11 pl-4 text-right' : 'pl-11 pr-4 text-left'} rounded-xl border border-[var(--border-input,#1B2738)] bg-[var(--surface-input,#0A101D)] text-[var(--text-main,#FFFFFF)] text-xs outline-none transition-all focus:border-[var(--primary,#E07A00)] placeholder-[var(--text-muted,#475569)] font-sans`}
          />
        </div>
        ...
        <div className="relative flex items-center">
          ...
          <input 
            ...
            required
            className={`w-full py-2.5 ${isRtl ? 'pr-11 pl-11 text-right' : 'pl-11 pr-11 text-left'} rounded-xl border border-[var(--border-input,#1B2738)] bg-[var(--surface-input,#0A101D)] text-[var(--text-main,#FFFFFF)] text-xs outline-none transition-all focus:border-[var(--primary,#E07A00)] placeholder-[var(--text-muted,#475569)] font-sans`}
          />
          <button
            type="button"
        ...
        {/* التنبيهات: تم نقل المكان قبل زر التسجيل للترتيب المنطقي */}
        {status.msg && (
          <div className={`p-3 rounded-xl my-1 text-xs leading-relaxed flex items-center gap-2 ${
            status.type === 'success' 
